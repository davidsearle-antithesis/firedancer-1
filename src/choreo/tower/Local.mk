...
$(call make-unit-test,test_tower_lockos,test_tower_lockos,fd_choreo fd_flamenco fd_funk fd_tango fd_ballet fd_util,$(SECP256K1_LIBS))
$(call run-unit-test,test_tower_lockos)
$(call make-unit-test,test_tower_serdes,test_tower_serdes,fd_choreo fd_flamenco fd_funk fd_tango fd_ballet fd_util,$(SECP256K1_LIBS))
$(call run-unit-test,test_tower_serdes)
$(call make-fuzz-test,fuzz_tower_serdes,fuzz_tower_serdes,fd_choreo fd_flamenco fd_funk fd_tango fd_ballet fd_util,$(SECP256K1_LIBS))
endif

...
/* fd_rserve_ping_cache_evict removes entries from the ping cache whose
   timestamp is older than FD_RSERVE_PING_CACHE_TTL_NS relative to
   now_ns.  Should be called from housekeeping. */
void
fd_rserve_ping_cache_evict( fd_rserve_t * rserve,
                            ulong         now_ns );

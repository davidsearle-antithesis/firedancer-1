...
after_credit( fd_backt_tile_t *   ctx,
  ...
  *charge_busy = 1;
  ...
  fd_stem_publish( stem, ctx->repair_out->idx, SHRED_SIG_FEC_COMPLETE, ctx->repair_out->chunk, fec_complete_sz, 0, 0UL, fd_frag_meta_ts_comp( fd_tickcount() ) );

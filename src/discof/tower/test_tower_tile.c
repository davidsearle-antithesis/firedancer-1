...
mock_vote_txn( ulong               root,
  ...
  static uchar tower_mem[ 1024 ] __attribute__((aligned(128)));
...
test_count_vote_txn( void ) {
  ...
  static uchar tower_mem2[ 1024 ] __attribute__((aligned(128)));
  ...
  ctx->tower         = fd_tower_join( fd_tower_new( tower_mem2, 0, 0, 0 ) );
